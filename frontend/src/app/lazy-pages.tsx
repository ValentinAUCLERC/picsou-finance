...
export const MfaChallengePage = lazy(() =>
  import("@/pages/login/MfaChallengePage").then((m) => ({
...
export const GoalCalendarPage = lazy(() =>
  import("@/pages/goals/GoalCalendarPage").then((m) => ({
    default: m.GoalCalendarPage,
  }))
)
...
export const ActivationPage = lazy(() =>
  import("@/pages/activation/ActivationPage").then((m) => ({
    default: m.ActivationPage,
  }))
)
export const FamilyDashboardPage = lazy(() =>
  import("@/pages/family/FamilyDashboardPage").then((m) => ({
    default: m.FamilyDashboardPage,
  }))
)
export const FamilySettingsPage = lazy(() =>
  import("@/pages/settings/FamilySettingsPage").then((m) => ({
    default: m.FamilySettingsPage,
  }))
)
...
export const SetupStepIntro = lazy(() =>
  import("@/pages/setup/SetupStepIntro").then((m) => ({
    default: m.SetupStepIntro,
  }))
)
export const SetupStepAdmin = lazy(() =>
  import("@/pages/setup/SetupStepAdmin").then((m) => ({
    default: m.SetupStepAdmin,
  }))
)
export const SetupStepSecurity = lazy(() =>
  import("@/pages/setup/SetupStepSecurity").then((m) => ({
    default: m.SetupStepSecurity,
  }))
)
export const SetupStepIntegrations = lazy(() =>
  import("@/pages/setup/SetupStepIntegrations").then((m) => ({
    default: m.SetupStepIntegrations,
  }))
)
export const SetupStepComplete = lazy(() =>
  import("@/pages/setup/SetupStepComplete").then((m) => ({
    default: m.SetupStepComplete,
  }))
)
